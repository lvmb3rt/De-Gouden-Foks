Shader "Hidden/Locked/.poiyomi/Old Versions/9.2/Poiyomi Pro/1e9adbdc238838e468e43866c87229b1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float calculateSSAO(PoiMesh poiMesh, PoiCam poiCam, inout PoiLight poiLight, inout PoiMods poiMods)
			{
				...
				float ssao = CalculateAmbientOcclusion(screenPos, depth, transformedNormal, 0.005, direction, poiMesh, poiCam);
			...
			void applySSAO(float ssao, in PoiMesh poiMesh, inout PoiFragData poiFragData, inout PoiMods poiMods, inout PoiLight poiLight)
			{
				...
				float3 ssaoColor = poiThemeColor(poiMods, float4(0.2086369,0.05126944,0.08650043,1).rgb, 0.0).rgb * lerp(1, poiFragData.baseColor, 0.0);
