Shader "Hidden/Locked/.poiyomi/Old Versions/9.2/Poiyomi Pro/b1e0ee328f6e5b74abe8d83c08bfe97c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.occlusion = min(min(min(lerp(1, AOMaps.r, 0.0), lerp(1, AOMaps.g, 0.0)), lerp(1, AOMaps.b, 0.0)), lerp(1, AOMaps.a, 0.55));
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1746474,0.1679254,0.1600616,1).rgb, 0.0);
