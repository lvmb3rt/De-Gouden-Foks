...
public class elevatorBrains : UdonSharpBehaviour
{
    ...
    private void OnPlayerConnected(VRCPlayerApi player)
    {
        ...
        {
            if (loadEvevatorFloor == 0)
            {
                F0();
            }
            else if (loadEvevatorFloor == 1)
            {
                F1();
            }
            else if (loadEvevatorFloor == 2)
            {
                F2();
            }
            else if (loadEvevatorFloor == 3)
            {
                F3();
            }
            else if (loadEvevatorFloor == 4)
            {
                F4();
            }
            else if (loadEvevatorFloor == 5)
            {
                F5();
            }
        }
    ...
    private void materialReturnToGreen()
    {
        ...
        loadEvevatorFloor = floorCurrent;
    }
}
