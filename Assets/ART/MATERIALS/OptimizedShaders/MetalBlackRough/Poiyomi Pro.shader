Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/ef4a78c5502175d4bb08a55ab477194e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.01219615,0.01219615,0.01219615,1).rgb, 0.0);
