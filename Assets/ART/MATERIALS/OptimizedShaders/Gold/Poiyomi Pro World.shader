Shader "Hidden/Locked/.poiyomi/Poiyomi Pro World/ac44fffd2225d4f4b8c8e0d2fbff6783"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, 0.638) * 0.638, pbrNDotV);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.8960326,0.7567444,0.295463,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.8960326,0.7567444,0.295463,1).a;
				#else
