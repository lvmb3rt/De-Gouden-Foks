Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/6f1d5173affc0224992279c2013d5dfc"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.5754442,0.5754442,0.5754442,1).rgb, 0.0);
